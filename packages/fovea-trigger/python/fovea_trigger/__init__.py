"""fovea-trigger: H.264 motion-vector trigger engine.
...
Quick start::
    ...
    from fovea_trigger import Stream, MotionTrigger, IntervalTrigger
...
from ._fovea_trigger import (  # type: ignore[import-not-found]
    Event,
    EventIterator,
    FusionTrigger,
    IntervalTrigger,
